function [sdr] = initSdr(rx_ch_size, tx_ch_size, Fs, rx_center_freq, tx_center_freq, rx_bw, tx_bw, rx_gain, agc_mode, sdr_mode)
...
%   Detailed explanation goes here
    ...
    sdr.in_ch_size = tx_ch_size;
    %out_ch_size Output data channel size [samples]
    sdr.out_ch_size = rx_ch_size;
    ...
    sdr.rx_rf_bandwidth = tx_bw;         % RX_RF_BANDWIDTH
    ...
    sdr.tx_center_freq = tx_center_freq;         % TX_LO_FREQ
